...
export class InvitesClient {
    ...
    ): core.HttpResponsePromise<IcePanel.organizations.users.InvitesListResponse> {
    ...
    private async __list(
        request: IcePanel.OrganizationUserInvitesListRequest,
        requestOptions?: InvitesClient.RequestOptions,
    ): Promise<core.WithRawResponse<IcePanel.organizations.users.InvitesListResponse>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `organizations/${core.url.encodePathParam(organizationId)}/users/invites`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as IcePanel.organizations.users.InvitesListResponse,
    ...
    /**
     * @param {IcePanel.OrganizationUserInviteCreateRequest} request
     * @param {InvitesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link IcePanel.UnauthorizedError}
     * @throws {@link IcePanel.NotFoundError}
    ...
    public create(
        ...
        requestOptions?: InvitesClient.RequestOptions,
    ): core.HttpResponsePromise<IcePanel.organizations.users.InvitesCreateResponse> {
    ...
    private async __create(
        request: IcePanel.OrganizationUserInviteCreateRequest,
        requestOptions?: InvitesClient.RequestOptions,
    ): Promise<core.WithRawResponse<IcePanel.organizations.users.InvitesCreateResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as IcePanel.organizations.users.InvitesCreateResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    /**
     * @param {IcePanel.OrganizationUserInviteRevokeRequest} request
     * @param {InvitesClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link IcePanel.UnauthorizedError}
     * @throws {@link IcePanel.NotFoundError}
    ...
    public revoke(
        ...
        requestOptions?: InvitesClient.RequestOptions,
    ): core.HttpResponsePromise<IcePanel.organizations.users.InvitesRevokeResponse> {
    ...
    private async __revoke(
        request: IcePanel.OrganizationUserInviteRevokeRequest,
        requestOptions?: InvitesClient.RequestOptions,
    ): Promise<core.WithRawResponse<IcePanel.organizations.users.InvitesRevokeResponse>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.IcePanelEnvironment.V1,
                `organizations/${core.url.encodePathParam(organizationId)}/users/invites/${core.url.encodePathParam(organizationUserInviteId)}`,
            ),
            method: "POST",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        if (_response.ok) {
            return {
                data: _response.body as IcePanel.organizations.users.InvitesRevokeResponse,
                rawResponse: _response.rawResponse,
            };
        }
